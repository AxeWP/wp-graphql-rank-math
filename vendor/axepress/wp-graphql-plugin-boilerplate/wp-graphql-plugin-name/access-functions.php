 ...
 * @return mixed
 */
function graphql_pb_get_setting( string $option_name, $default = '', $section_name = 'graphql_pb_settings' ) {
	 ...
	 */
	$section_fields = apply_filters( 'graphql_pb_get_setting_section_fields', $section_fields, $section_name, $default );
	 ...
	 */
	return apply_filters( 'graphql_pb_get_setting_section_field_value', $value, $default, $option_name, $section_fields, $section_name );
}
