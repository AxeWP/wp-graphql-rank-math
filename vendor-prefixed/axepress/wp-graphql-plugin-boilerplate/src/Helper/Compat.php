...
if (!class_exists('\WPGraphQL\RankMath\Vendor\AxeWP\GraphQL\Helper\Compat')) {
    /**
     * Class - Compat
     */
    class Compat
    {
        ...
        public static function resolve_graphql_config(array $config): array
        {
             ...
             */
            $nested_configs = ['args', 'connectionArgs', 'connectionFields', 'fields', 'inputFields', 'outputFields', 'values'];
